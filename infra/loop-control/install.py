...
CONTROL_UNITS = [
    ...
    "loop-continuous-report.service", "loop-continuous-report.timer",
]
WORKER_FILES = {
    ROOT / "tools/loop/continuous_receiver.py": (Path("/usr/local/sbin/loop-continuous-register"), 0o755),
...
RUNNER_FILES = {
    ...
    CONF / "continuous-acceptance/manifests/0153b1605b448cd63e74819413b727f27e87761f.json": (Path("/opt/loop-review/continuous/manifests/0153b1605b448cd63e74819413b727f27e87761f.json"), 0o644),
