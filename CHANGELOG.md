...
Попало в `main` 07.09-08.09.2026 (ночь 07-08.09, D31, и день 08.09, D32 + трек D35); релизная привязка - тег `v2026.09.22-2` и релиз M-01 22.09.2026 (см. `docs/operations/releases/2026-09-22-m01.md`).
