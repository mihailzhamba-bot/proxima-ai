...
**Plans**: 2/3 implemented - `02-01` and early-feedback `02-01A` verified; `02-01A` is deployed to staging, while private inputs, live Telegram acceptance and CI evidence remain pending; `02-02` waits for the official WB XLSX checkpoint.
