window.STATE =
{
  ...
  "updatedAt": "2026-08-28T10:35:00+03:00",
  "finishedAt": null,
  "stages": [
    ...
    { "id": "build", "status": "active", "startedAt": "2026-08-28T09:15:00+03:00", "note": "3 из 4 тасков готовы" },
    { "id": "review", "status": "active", "startedAt": "2026-08-28T09:25:00+03:00", "note": "проверено 3 из 4" },
    { "id": "final", "status": "pending" }
  ],
  "requirements": {
    "total": 20, "done": 17, "inTicket": 3, "inSpec": 0,
  ...
  "tickets": [
    ...
    { "id": "02", "title": "R1: Jira policy, pre-write ledger и safe repair", "requirements": ["R15","R16","R17","R18"], "blockedBy": ["01"], "wave": 2, "zone": ["tools/now_orchestrator/jira/","scripts/agent/now","tools/tests/test_now_jira.py",".claude/commands/now.md",".codex/skills/now/SKILL.md",".opencode/commands/now.md",".codex/config.toml"], "status": "done", "startedAt": "2026-08-28T09:36:00+03:00", "finishedAt": "2026-08-28T10:06:00+03:00", "retries": 1, "repairs": 2, "handoffs": 0, "files": ["tools/now_orchestrator/jira/","tools/now_orchestrator/__main__.py","tools/tests/test_now_jira.py",".claude/commands/now.md",".codex/skills/now/SKILL.md",".opencode/commands/now.md",".codex/config.toml"], "tests": { "passed": 27, "failed": 0 }, "commit": "9497f68", "concerns": ["assign null/null regression is not isolated in one negative test", "boolean issue_count and empty transition ID share one assertion", "forged-contract and unresolved-key cases are covered through combined boundary tests rather than isolated mutation tests"] },
    { "id": "03", "title": "R2: track claims, file zones, lifecycle и integration lock", "requirements": ["R05","R06","R08","R12"], "blockedBy": ["01","02"], "wave": 3, "zone": ["tools/now_orchestrator/runtime/","tools/now_orchestrator/__main__.py","scripts/agent/now","tools/tests/test_now_runtime.py",".claude/commands/now.md",".codex/skills/now/SKILL.md",".opencode/commands/now.md"], "status": "done", "startedAt": "2026-08-28T10:07:00+03:00", "finishedAt": "2026-08-28T10:35:00+03:00", "retries": 1, "repairs": 2, "handoffs": 0, "files": ["tools/now_orchestrator/runtime/","tools/now_orchestrator/__main__.py","scripts/agent/now","tools/tests/test_now_runtime.py",".claude/commands/now.md",".codex/skills/now/SKILL.md",".opencode/commands/now.md"], "tests": { "passed": 13, "failed": 0 }, "commit": "b523d10", "concerns": ["claim release traversal is protected in production but lacks a direct real-lease victim regression", "same-owner integration lease resume is implemented but not isolated in its own assertion"] },
    { "id": "04", "title": "R3: три adapters, supervised dispatch и close transaction", "requirements": ["R07","G01","G02"], "blockedBy": ["01","02","03"], "wave": 4, "zone": [".claude/commands/",".codex/skills/",".codex/config.toml",".opencode/commands/",".opencode/skills/",".opencode/agents/","docs/agent-system/","docs/release-gates/","tools/now_orchestrator/integration/","scripts/agent/now","tools/tests/test_now_adapters.py"], "status": "review", "startedAt": "2026-08-28T10:36:00+03:00", "retries": 2, "repairs": 4, "handoffs": 1, "tests": { "passed": 142, "failed": 0 }, "concerns": ["independent final re-review 0 blocker/0 warning pending", "no live Jira/Orca/GitHub effects were performed"] }
  ],
  "singlePass": null,
  "tests": { "passed": 202, "failed": 0, "skipped": 4 },
