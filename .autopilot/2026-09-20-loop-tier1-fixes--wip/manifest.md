...
| D04 | Ребейз на 79115e8 принёс унаследованный красный: верификатор agent-toolset (строгий) против конфига с транспорт-ключами (решение #155/#156 с main). Конфиг ветки уже соответствовал контракту main - не хватало самого верификатора; черри-пик 6513307 (c2badd6) сделал гейт зелёным | 2026-09-21 |
