...
| 2026-08-27 | `2026-08-27-pmm20-scn001-core` | сдан | Ядро детектора SCN-001 в control-plane: сезонный baseline 7/14/28, Шепли U×CVR×AOV, ₽-фильтр топ-10, дедуп, loader staging + smoke; make verify PASS, 43 теста, кросс-модельный codex-гейт 0B/0W (3 раунда), PMM-20 «В работе» (комментарии 10376/10378) |
