...
| 2026-08-27 | `2026-08-27-pmm20-scn001-core` | сдан | Ядро детектора SCN-001 в control-plane: сезонный baseline 7/14/28, Шепли U×CVR×AOV, ₽-фильтр топ-10, дедуп, loader staging + smoke; make verify PASS, 33 теста, PMM-20 «В работе» (комментарий 10376) |
