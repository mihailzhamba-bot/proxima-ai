 ...
 * Форма живёт в @/lib/data/view-model и общая для fixtures и будущего Postgres (PA-50).
 * Значения структурные (DEC-006: unreleased, fixtures-режим).
 */

import type { Metric } from "@/lib/data/view-model";

export type { Metric, MetricFormat, MetricId } from "@/lib/data/view-model";
