...
export const user = webappAuthSchema.table("user", {
...
export const session = webappAuthSchema.table("session", {
  id: text("id").primaryKey(),
...
export const verification = webappAuthSchema.table("verification", {
  id: text("id").primaryKey(),
