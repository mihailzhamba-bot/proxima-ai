...
host_analytics_token="${secrets_dir}/${tenant}_wb_analytics_token"
...
[[ -r "$host_analytics_token" ]] || fail "tenant analytics token file is missing or unreadable"
...
# paths contain data, not command-line values, and are mounted by compose.
