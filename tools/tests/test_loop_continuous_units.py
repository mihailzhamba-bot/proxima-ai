...
def write_units(tmp_path,exec_start,environment="UV_OFFLINE=1 UV_PYTHON_DOWNLOADS=never"):
...
def test_verify_units_accepts_only_exact_uv_form(monkeypatch,tmp_path):
 ...
 missing=write_units(tmp_path/"missing"," ".join(m.UV_EXEC),"UV_OFFLINE=1")
