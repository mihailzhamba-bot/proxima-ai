...
- **M4** разведка «Источники v2»: черновик эпика по остаткам и финансовому отчёту из уже собранных фактов проб (`docs/state/API-FACTS.md`, разделы про остатки 02.09 и async CSV), без единого живого вызова WB - **GLM**.
