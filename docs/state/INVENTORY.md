...
> **22.09.2026:** документ покрывает VPS claudette. Машина harper (135.106.211.64, mainline-чекаут + LOOP-верификатор) описана отдельно - `HOST-harper.md`; события 20-21.09 (D40/PR #154, D41, D42) в §5 не отражены.
