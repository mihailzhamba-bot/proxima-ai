...
| PMM-16 | Backlog | onboarding AI-ops аналитика | вне | актуально | Аналитик определён 02.09.2026: Владислав (роль - `docs/agent-system/roles/analyst-vladislav.md`, четыре зоны проверки, онбординг первой недели). Задачу переписать: «Онбординг Владислава: доступы по чек-листу, первая сверка с кабинетом до 08.09, разметка ретро-тревог, замер SM-3 до 20.09» (sync-brief 03.09) |
